...
public class AuthenticationController {
    ...
    private static final Logger authLogger = LoggerFactory.getLogger(AuthenticationController.class);
    ...
    // This endpoint now uses GestUtenteService and aligns with existing web
    // registration flow
