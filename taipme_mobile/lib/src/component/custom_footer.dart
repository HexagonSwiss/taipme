...
class CustomFooter extends ConsumerWidget {
  ...
  const CustomFooter({super.key,required this.isChatSelected,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          // Icon Chat
          Transform.translate(
            offset: isChatSelected ? Offset(0, -40) : Offset(0, 0), // Sposta l'icona verso l'alto se selezionata
            child: Container(
              decoration: BoxDecoration(
                color: TaipmeStyle.backgroundColorInput, // Colore di sfondo
                shape: BoxShape.circle, // Forma circolare
                border: Border.all(
                  color: isChatSelected ? TaipmeStyle.backgroundColor : TaipmeStyle.backgroundColorInput, // Colore del bordo
                  width: 15,
                ),
              ),
          ...
          Transform.translate(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle, // Forma circolare
                border: Border.all(
                  color: isHomeSelected ? TaipmeStyle.backgroundColor : TaipmeStyle.backgroundColorInput, // Colore del bordo
                  width: 15,
                ),
              ),
              padding: EdgeInsets.all(13),
          ...
          Transform.translate(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle, // Forma circolare
                border: Border.all(
                  color: isSettingsSelected ? TaipmeStyle.backgroundColor : TaipmeStyle.backgroundColorInput, // Colore del bordo
                  width: 15,
                ),
              ),
              padding: EdgeInsets.all(13),
