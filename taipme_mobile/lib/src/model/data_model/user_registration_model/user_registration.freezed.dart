...
UserRegistrationModel _$UserRegistrationModelFromJson(
  ...
  return _UserRegistrationModel.fromJson(json);
}
...
/// @nodoc
abstract class $UserRegistrationModelCopyWith<$Res> {
  factory $UserRegistrationModelCopyWith(UserRegistrationModel value,
          $Res Function(UserRegistrationModel) then) =
      _$UserRegistrationModelCopyWithImpl<$Res, UserRegistrationModel>;
  @useResult
  $Res call(
      {DateTime? createdAt,
      DateTime? updatedAt,
...
class _$UserRegistrationModelCopyWithImpl<$Res,
        $Val extends UserRegistrationModel>
    implements $UserRegistrationModelCopyWith<$Res> {
  _$UserRegistrationModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UserRegistrationModelImplCopyWith<$Res>
    implements $UserRegistrationModelCopyWith<$Res> {
  factory _$$UserRegistrationModelImplCopyWith(
          _$UserRegistrationModelImpl value,
          $Res Function(_$UserRegistrationModelImpl) then) =
      __$$UserRegistrationModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DateTime? createdAt,
...
/// @nodoc
class __$$UserRegistrationModelImplCopyWithImpl<$Res>
    extends _$UserRegistrationModelCopyWithImpl<$Res,
        _$UserRegistrationModelImpl>
    implements _$$UserRegistrationModelImplCopyWith<$Res> {
  __$$UserRegistrationModelImplCopyWithImpl(_$UserRegistrationModelImpl _value,
      $Res Function(_$UserRegistrationModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UserRegistrationModelImpl(
      createdAt: freezed == createdAt
          ? _value.createdAt
          : createdAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
...
/// @nodoc
@JsonSerializable()
class _$UserRegistrationModelImpl implements _UserRegistrationModel {
  const _$UserRegistrationModelImpl(
      {this.createdAt,
      this.updatedAt,
      this.deletedAt,
      this.birthDate,
  ...
  factory _$UserRegistrationModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserRegistrationModelImplFromJson(json);
...
// Download URL OR StoragePath
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserRegistrationModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UserRegistrationModelImplCopyWith<_$UserRegistrationModelImpl>
      get copyWith => __$$UserRegistrationModelImplCopyWithImpl<
          _$UserRegistrationModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserRegistrationModelImplToJson(
      this,
    );
  }
}

abstract class _UserRegistrationModel implements UserRegistrationModel {
  const factory _UserRegistrationModel(
      {final DateTime? createdAt,
      final DateTime? updatedAt,
      final DateTime? deletedAt,
      final DateTime? birthDate,
      ...
      final bool consentToPrivacyPolicy,
      final bool consentToNewsletter,
      final bool consentToPushNotifications}) = _$UserRegistrationModelImpl;

  factory _UserRegistrationModel.fromJson(Map<String, dynamic> json) =
      _$UserRegistrationModelImpl.fromJson;
