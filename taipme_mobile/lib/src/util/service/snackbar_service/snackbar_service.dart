...
@riverpod
Future<SnackBarClosedReason> snackBarService(
  Ref ref, {
  ...
  debugPrint('Service: snackBarService text is: $text');
  ...
  final snackBar = SnackBar(
    ...
    backgroundColor: successOrFail == true ? TaipmeStyle.primaryColor : Colors.red,
